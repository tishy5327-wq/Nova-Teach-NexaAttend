...
export default function App() {
  ...
  // --- Main website state and logic (full original website) ---
  ...
  useEffect(() => {
    ...
    // (other meta tags omitted but same as original)
  }, []);
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 640px) {
          ...
          .flex-cte a, .flex-cta button { width: 100% !important; justify-content: center !important; }
