    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#F8F6F1", color: "#1A1916", overflowX: "hidden" }}>
      ...
      <section id="pricing" style={{ padding: "120px 6%", background: "#F8F6F1" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <FadeIn>
            ...
            <h2 className="serif" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", letterSpacing: "-0.02em", marginBottom: 14 }}>
              Simple, transparent pricing.
            </h2>
            <p style={{ fontSize: 16, color: "rgba(26,25,22,0.55)", marginBottom: 12, lineHeight: 1.8 }}>
      ...
      <section id="process" style={{ padding: "120px 6%", background: "#FFFFFF" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeIn>
            ...
            <h2 className="serif" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", letterSpacing: "-0.02em", marginBottom: 16 }}>
              From demo to live system in 3 days.
            </h2>
            <p style={{ fontSize: 16, color: "rgba(26,25,22,0.55)", maxWidth: 480, marginBottom: 60, lineHeight: 1.8 }}>
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div style={{ position: "relative" }}>
                  ...
                  <div style={{ width: 56, height: 56, borderRadius: 14, background: i === 3 ? "#2D5A3D" : "#F8F6F1", border: i === 3 ? "none" : "1px solid rgba(26,25,22,0.12)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, fontSize: 22 }}>
                    {s.icon}
                  </div>
      ...
      <section id="demo" style={{ padding: "120px 6%", background: "#2D5A3D" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          <FadeIn>
            <div className="mono" style={{ fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(248,246,241,0.45)", marginBottom: 20 }}>
