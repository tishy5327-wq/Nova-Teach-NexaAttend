  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#F8F6F1", color: "#1A1916", overflowX: "hidden" }}>
      ...
      <div className={`mmenu ${menuOpen ? "open" : ""}`}>
        {/* Nav links */}
        {[["problem","Why NexaAttend"],["solution","Solution"],["pricing","Pricing"],["process","How It Works"],["trust","Trust"]].map(([id, label]) => (
        ...
        <div style={{ marginTop: 32, padding: "20px 0", borderTop: "1px solid rgba(26,25,22,0.08)" }}>
          ...
          <a href="https://linkedin.com/company/nova-teach-solutions" target="_blank" rel="noopener noreferrer"
            ...
            <span style={{ width: 36, height: 36, borderRadius: 8, background: "rgba(10,102,194,0.08)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <LiIcon />
            </span>
            Follow on LinkedIn
          </a>
          ...
          {/* Book Demo CTA */}
          <button className="btn-green" onClick={() => scrollTo("demo")} style={{ width: "100%", justifyContent: "center" }}>
            Book Free Demo
          </button>
        </div>
      </div>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <a href="tel:+919974724656" className="btn-outline hide-mob" style={{ padding: "8px 14px", fontSize: 13 }}>
            +91 99747 24656
          </a>
          <button className="btn-primary" onClick={() => scrollTo("demo")} style={{ padding: "9px 16px", fontSize: 13 }}>
            Book Demo
          </button>
      ...
      <footer style={{ background: "#111110", padding: "48px 6% 28px", color: "#F8F6F1" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="ftgrid g2" style={{ gap: 48, paddingBottom: 36, borderBottom: "1px solid rgba(248,246,241,0.08)" }}>
            ...
            <div className="ftcols" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
              <div>
                ...
                {[["Features","solution"],["Pricing","pricing"],["How It Works","process"],["Book Demo","demo"]].map(([l, id]) => (
          ...
          <div style={{ paddingTop: 22, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
            <div style={{ fontSize: 12, color: "rgba(248,246,241,0.25)" }}>© {new Date().getFullYear()} Nova Teach Solution. Founded by Shahs Tishya.</div>
